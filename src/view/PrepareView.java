...
public class PrepareView {
	...
	private Button delBut, prepareBtn;
...
//		Add Button prepare untuk role chef
		form.add(prepareBtn, 1, 1);
	
		return form;
	}


	public PrepareView(Stage stage) {
		VBox root = new VBox(); 
	...
	public Button getPrepareBtn() {
		return prepareBtn;
	}

	public void setPrepareBtn(Button prepareBtn) {
